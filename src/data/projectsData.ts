...
export const projects = [
  ...
  },
  {
    ...
    description: "Bot de X/Twitter que se dedica a publicar fotos de Lionel Messi diariamente. Fue creado con la API de X/Twitter, y cuenta con +4.000 seguidores.",
